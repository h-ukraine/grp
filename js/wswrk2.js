...
// self.importScripts("../js/commandproc.js");
...
function wsConnect() {
    ...
    //
    let wstarg = "ws://" + "develop.onserver.site:50700" + '/chat=gena'; // route to 192.168.0.133:50700
    // wstarg = "ws://" + "192.168.0.124:50700" + '/chat=gena';
    // wstarg = "ws://" + "31.148.150.251:50700" + '/chat=gena';
    // wstarg = "ws://" + "192.168.0.113:50700" + '/chat=gena';
...
callback_GetText = (evt) => {
    ...
    var xxx = "[wrk-2]: get wssocket_data... " + _typ + ', ' + _cmdtyp + ",  tm=" + tm_time;
...
self.onmessage = function(e) {
    console.log("self: wrk-2 received: " + e.data);
};
...
console.log("[wrk-2]: bc receiver started " + performance.now().toFixed(1));
// console.log("[wrk-2]: Connected " + performance.now().toFixed(1));
bc.onmessage = function(ev) {
    ...
    switch (ev.data.type) {
        ...
        case "wsopenack":
            wsopenAcked = true;
            console.log('[wrk-2]: wsopenack! cnt=' + wsopcnt);
            totalid = ev.data.totalid;
            break;
        case "tmax=300":
            tm_time = 250;
        ...
        case "_wsocket":
            ...
            console.log("[wrk-2]: send to websocket,  type= " + CmdTypeToString(ev.data.ObjectType) +
                ' ' + performance.now().toFixed(1));
            sendCmd(ev.data);

            break;
        default:
            // console.log("[wrk-2]: case Not defined!!");
            break;
