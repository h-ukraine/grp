...
function fillgrp_params_feedback(obj) {
    ...
    if (vismode == 3)
        ...
        tbl.rows.forEach(row => {
            ...
            row.style.gridTemplateColumns = 'repeat(2, 0.5fr)  repeat(' + (tbl.colCount - 2).toString() + ', 1.9fr)';
            ...
            if (tbl.rows.indexOf(row) == 0) {
                row.children[0].innerText = 'Сервер';
            ...
            por1.forEach(elem => {
                if (k < rc) {
                    if (vismode == 4) {
                        ...
                        tbl.row(k).style.gridTemplateColumns = 'repeat(2, 0.5fr)  repeat(' + (tbl.colCount - 2).toString() + ', 1.9fr)';
            ...
            arr.forEach(j => {
                ...
                if (i < tbl.rowCount) {
                    ...
                    if ((dev[0].bitmask & 0xe23e & (1 << j)) && (vismode == 3)) {
                        ...
                        tbl.row(i).style.gridTemplateColumns = '0.5fr 0.5fr  1.9fr 3.8fr';
